...
@Component({
  selector: 'app-moje-trasy',
  templateUrl: './moje-trasy.component.html',
  styleUrls: ['./moje-trasy.component.css']
})
export class MojeTrasyComponent implements OnInit {
  ...
  public origin: any = { "lat": 50.8173243, "lng": 19.1115747 };
  public destination: any = { "lat": 59.32932349999999, "lng": 18.0685808 };
  public waypoints = [{ "location": { "lat": 52.2296756, "lng": 21.0122287, "stopover": true } }, { "location": { "lat": 56.9496487, "lng": 24.1051864, "stopover": true } }];
